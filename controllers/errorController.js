...
const sendErrorProd = (err, res) => {
  ...
  if (err.isOperational) {
    ...
    //Programing error or unknown error so we don't want to leak it to client
    //1. log error
...
module.exports = (err, req, res, next) => {
  //this is an error first function which mong will recognize as error handling and take it from there.
